...
class NagImportClass
{
    ...
    private $arrSession          = array();     // Session content
            ...
            if (($intIsTemplate == 0) && ($strKeyField != "") && isset($arrImportData[$strKeyField])) {
                if ($strHash == "") {
                    ...
                    if ($strBlockKey == "hostextinfo") {
                        ...
                        $intHost = intval($this->myDBClass->getFieldData($strSQL));
