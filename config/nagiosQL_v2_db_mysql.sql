...
-- // Datum:	02.04.2007
-- // Zweck:	MySQL Datenbank erstellen
-- // Datei:	config/nagiosQL_db_mysql.sql
-- // Version:  2.00-BETA-P00
-- //
-- ///////////////////////////////////////////////////////////////////////////////
...
CREATE TABLE `tbl_host` (
  ...
  `freshness_threshold` smallint(5) unsigned default NULL,
...
(221, '1.00', 'admintable', 'deleteok', 'Sollen die markierten Einträge wirklich gelöscht werden?', 'Do you really want to delete all marked entries?', NULL),
(222, '1.00', 'admintable', 'deletesingle', 'Soll dieser Datenbankeintrag wirklich gelöscht werden:', 'Do you really want to delete this single database entry?', NULL),
...
(229, '1.00', 'formchecks', 'fill_member', 'Bitte Mitglieder auswählen!', 'Please select at least one member!', NULL),
...
(233, '1.00', 'formchecks', 'fill_speriod', 'Bitte eine Servicezeitperiode auswählen!', 'Please select a service check period!', NULL),
(234, '1.00', 'formchecks', 'fill_hperiod', 'Bitte eine Hostzeitperiode auswählen!', 'Please select a host check period!', NULL),
(235, '1.00', 'formchecks', 'fill_dephost', 'Bitte mindestens einen abhängigen Host auswählen!', 'Please select at least one dependent host!', NULL),
(236, '1.00', 'formchecks', 'fill_host', 'Bitte einen Host auswählen!', 'Please select a host!', NULL),
(237, '1.00', 'formchecks', 'fill_hosts', 'Bitte mindestens einen Host auswählen!', 'Please select at least one host!', NULL),
(238, '1.00', 'formchecks', 'fill_depserv', 'Bitte mindestens einen abhängigen Service auswählen!', 'Please select at least one dependent service!', NULL),
(239, '1.00', 'formchecks', 'fill_serv', 'Bitte einen Service auswählen!', 'Please select a service!', NULL),
(240, '1.00', 'formchecks', 'fill_servs', 'Bitte mindestens einen Service auswählen!', 'Please select at least one service!', NULL),
(241, '1.00', 'formchecks', 'fill_deserv', 'Eine Host/Service Kombination kann nicht\\nvon sich selbst abhängig sein!', 'A host/service combination can not depend of itself!', NULL),
...
(244, '1.00', 'formchecks', 'fill_nfint', 'Bitte eine Wiederholungszeit für\\ndie Alarmierung eintragen!', 'Please fill in the notification interval', NULL),
(245, '1.00', 'formchecks', 'fill_cgroup', 'Bitte mindestens eine Kontaktgruppe auswählen!', 'Please select at least one contact group!', NULL),
...
(251, '1.00', 'formchecks', 'fill_checkper', 'Bitte eine Prüfzeitperiode auswählen!', 'Please select a check period!', NULL),
(252, '1.00', 'formchecks', 'fill_checkatt', 'Bitte die Anzahl maximaler Prüfungen\\nbis zur Alarmauslösung eintragen!', 'Please fill in the maximal check attempts!', NULL),
(253, '1.00', 'formchecks', 'fill_notperiod', 'Bitte eine Alarmierungszeitperiode auswählen!', 'Please select a notification period!', NULL),
(254, '1.00', 'formchecks', 'fill_noption', 'Bitte die Alarmierungsoptionen eintragen!', 'Please check the notification options!', NULL),
(255, '1.00', 'formchecks', 'fill_nochkint', 'Bitte das OK Prüfintervall eintragen!', 'Please fill in the normal check interval!', NULL),
(256, '1.00', 'formchecks', 'fill_rechkint', 'Bitte das nicht-OK Prüfintervall eintragen!', 'Please fill in the retry check interval!', NULL),
(257, '1.00', 'formchecks', 'fill_chkcomm', 'Bitte einen Prüfbefehl auswählen', 'Please select a check command', NULL),
...
(260, '1.00', 'formchecks', 'fill_host_gr', 'Bitte mindestens einen Hostnamen oder Hostgruppennamen auswählen!', 'Please select at least one host or host group!', NULL),
(261, '1.00', 'formchecks', 'fill_hostorgr', 'Es können nur Hosts oder Hostgruppen verwendet werden, keine Kombinationen!', 'Only hosts or host groups can be selected - no combinations of them!', NULL),
(262, '1.00', 'formchecks', 'fill_service_gr', 'Bitte mindestens einen Service oder Servicegruppennamen auswählem!', 'Please select at least one service or service group name!', NULL),
(263, '1.00', 'formchecks', 'fill_servg_only', 'Servicegruppen können nur alleine, also nicht in Kombination\\nmit Hosts, Hostgruppen oder einzelnen Services ausgewählt werden!', 'Service groups can only be used alone - not in combination with hosts, host groups or single services!', NULL),
(264, '1.00', 'formchecks', 'fill_hostorsgr', 'Bitte mindestens einen Host oder mindestens eine Servicegruppe auswählen!', 'Please select at least one host or service group!', NULL),
(265, '1.00', 'formchecks', 'fill_depservgr', 'Bitte mindestens eine abhängige Servicegruppe auswählen!', 'Please select at least one dependent service group!', NULL),
(266, '1.00', 'formchecks', 'fill_servgr', 'Bitte mindestens eine Servicegruppe auswählen!', 'Please select at least one service group!', NULL),
(267, '1.00', 'formchecks', 'fill_dephostgr', 'Bitte mindestens eine abhängige Hostgruppe auswählen!', 'Please select at least one dependent host group!', NULL),
(268, '1.00', 'formchecks', 'fill_hostgr', 'Bitte mindestens eine Hostgruppe auswählen!', 'Please select at least one host group!', NULL),
...
(273, '1.00', 'formchecks', 'fill_pwdnoteq', 'Passwörter sind ungleich!', 'The passwords are not equal!', NULL),
(274, '1.00', 'formchecks', 'fill_pwdshort', 'Passwort ist zu kurz - mindestens 6 Zeichen sind nötig!', 'The password is too short - use at least 6 characters!', NULL),
(275, '1.00', 'formchecks', 'fill_illeguser', 'Ungültige Zeichen im Benutzernamen!', 'The user name contains illegal characters!', NULL),
...
(279, '1.00', 'formchecks', 'fill_illegchar2', ' enthält unerlaubte Zeichen!', ' contains illegal characters!', NULL),
...
(309, '1.00', 'file', 'binaryfail', 'Nagios Binary nicht gefunden oder keine Rechte zum ausf&auml;hren!', 'Cannot find the Nagios binary or no rights for execution!', NULL),
...
(431, '2.00', 'admintable', 'noactivate', 'Eintrag kann nicht deaktiviert werden, da er als obligatorischer Eintrag in einer anderen Konfiguration verwendet wird', 'Entry cannot be activated because it is used by another configuration', NULL),
...
(447, '2.00', 'formchecks', 'fill_hostcmd', 'Bitte mindestens einen Host Befehl auswählen!', 'Please fill in at least one host command!', NULL),
(448, '2.00', 'formchecks', 'fill_servcmd', 'Bitte mindestens einen Service Befehl auswählen!', 'Please fill in at least one service command!', NULL),
...
-- 
-- Tabellenstruktur für Tabelle `tbl_misccommand`
-- 
...
-- 
-- Tabellenstruktur für Tabelle `tbl_relation`
-- 
...
-- 
-- Tabellenstruktur für Tabelle `tbl_relation_special`
-- 
