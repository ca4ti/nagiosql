...
CREATE TABLE tbl_contact (
  ...
  host_notification_period varchar(20) NOT NULL default '',
  service_notification_period varchar(20) NOT NULL default '',
...
CREATE TABLE tbl_mainmenu (
  ...
  PRIMARY KEY  (id)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='Hauptmenutabelle';
...
CREATE TABLE tbl_submenu (
  ...
  rights varchar(10) NOT NULL default '',
  PRIMARY KEY  (id)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 PACK_KEYS=0 COMMENT='Untermenutabelle';
