    ...
    <form name="frmDatalist" method="post" action="{ACTION_MODIFY}">
        <table style="border: 0; border-spacing: 1px; border-collapse: separate;" class="content_formtable">
            <tr>
                ...
                <td style="width: 70px; {FILTER_VISIBLE} {FILTER_REG_VISIBLE}">{LANG_REGISTERED}:</td>
                <td style="width: 50px; {FILTER_VISIBLE} {FILTER_REG_VISIBLE}"><select name="selRegFilter" id="selRegFilter" title="{LANG_REGISTERED}" class="selectborder" style="width: 50px;" onchange="document.frmDatalist.submit();">
                ...
                <td style="width: 40px; {FILTER_VISIBLE}">{LANG_ACTIVE}:</td>
                <td style="width: 50px; {FILTER_VISIBLE}"><select name="selActiveFilter" id="selActiveFilter" title="{LANG_ACTIVE}" class="selectborder" style="width: 50px;" onchange="document.frmDatalist.submit();">
