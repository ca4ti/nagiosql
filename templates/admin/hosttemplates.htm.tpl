                ...
                <div id="tab1">
                    <table border="0" cellpadding="0" class="content_formtable">
                        ...
                        <tr>
                            ...
                            <td class="content_tbl_row2"><input title="{LANG_TEMPLATE_NAME}" name="tfValue1" type="text" id="tfValue1" value="{DAT_TEMPLATE_NAME}" class="inpmust" tabindex="1"></td>
                            ...
                            <td class="content_tbl_row2"><input title="{LANG_DESCRIPTION}" name="tfValue2" type="text" id="tfValue2" value="{DAT_ALIAS}" tabindex="2"></td>
...
<!-- END hostgroup -->
                        ...
                        <tr class="{VERSION_30_VISIBLE}">
                            ...
                            <td>
                                <table cellpadding="0" cellspacing="0" border="0">
                                    <tr>
                                        <td class="radio_cell_1"><input title="+" name="radValue1" type="radio" class="checkbox" id="radValue10" value="0" {DAT_PAR0_CHECKED} tabindex="3"></td>
                                        <td class="radio_cell_2">+</td>
                                        <td class="radio_cell_1"><input title="null" name="radValue1" type="radio" class="checkbox" id="radValue11" value="1" {DAT_PAR1_CHECKED} tabindex="3"></td>
                                        <td class="radio_cell_2">null</td>
                                        <td class="radio_cell_1"><input title="{LANG_STANDARD}" name="radValue1" type="radio" class="checkbox" id="radValue12" value="2" {DAT_PAR2_CHECKED} tabindex="3"></td>
                            ...
                            <td>
                                <table cellpadding="0" cellspacing="0" border="0">
                                    <tr>
                                        <td class="radio_cell_1"><input title="+" name="radValue2" type="radio" class="checkbox" id="radValue20" value="0" {DAT_HOG0_CHECKED} tabindex="4"></td>
                                        <td class="radio_cell_2">+</td>
                                        <td class="radio_cell_1"><input title="null" name="radValue2" type="radio" class="checkbox" id="radValue21" value="1" {DAT_HOG1_CHECKED} tabindex="4"></td>
                                        <td class="radio_cell_2">null</td>
                                        <td class="radio_cell_1"><input title="{LANG_STANDARD}" name="radValue2" type="radio" class="checkbox" id="radValue22" value="2" {DAT_HOG2_CHECKED} tabindex="4"></td>
                                        <td class="radio_cell_2">{LANG_STANDARD}</td>
                                    </tr>
                                </table>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <select title="{LANG_CHECK_COMMAND}" name="selValue1" id="selValue1" class="selectborder" onChange="setIframe(this.value);" tabindex="5">
<!-- BEGIN hostcommand -->
...
<!-- END hostcommand -->
                            ...
                            <td>{LANG_ACTIVE}</td>
                            <td colspan="2"><input title="{LANG_ACTIVE}" name="chbActive" type="checkbox" class="checkbox" id="chbActive" value="1" {ACT_CHECKED} {ACT_DISABLED} tabindex="6">
                        ...
                        <tr>
                            <td>$ARG1$</td>
                            <td><input title="$ARG1$" name="tfArg1" type="text" id="tfArg1" value="{DAT_ARG1}" tabindex="7"></td>
                            ...
                            <td>$ARG5$</td>
                            <td colspan="2"><input title="$ARG5$" name="tfArg5" type="text" id="tfArg5" value="{DAT_ARG5}" tabindex="11"></td>
                        </tr>
                        <tr>
                            <td>$ARG2$</td>
                            <td colspan="2"><input title="$ARG2$" name="tfArg2" type="text" id="tfArg2" value="{DAT_ARG2}" tabindex="8"></td>
                            <td>$ARG6$</td>
                            <td colspan="2"><input title="$ARG6$" name="tfArg6" type="text" id="tfArg6" value="{DAT_ARG6}" tabindex="12"></td>
                        </tr>
                        <tr>
                            <td>$ARG3$</td>
                            <td colspan="2"><input title="$ARG3$" name="tfArg3" type="text" id="tfArg3" value="{DAT_ARG3}" tabindex="9"></td>
                            <td>$ARG7$</td>
                            <td colspan="2"><input title="$ARG7$" name="tfArg7" type="text" id="tfArg7" value="{DAT_ARG7}" tabindex="13"></td>
                        </tr>
                        <tr>
                            <td>$ARG4$</td>
                            <td colspan="2"><input title="$ARG4$" name="tfArg4" type="text" id="tfArg4" value="{DAT_ARG4}" tabindex="10"></td>
                            <td>$ARG8$</td>
                            <td colspan="2"><input title="$ARG8$" name="tfArg8" type="text" id="tfArg8" value="{DAT_ARG8}" tabindex="14"></td>
                        </tr>
                        <tr>
                            <td colspan="6">&nbsp;</td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <select title="{LANG_TEMPLATE_NAME}" name="selTemplate" class="selectborder" tabindex="15">
<!-- BEGIN template -->
                        ...
                        <tr>
                            ...
                            <td>
                                <table cellpadding="0" cellspacing="0" border="0">
                                    <tr>
                                        <td>
                                            <select title="{LANG_CONTACT_GROUPS}" name="mselValue4[]" size="4" multiple id="mselValue4" class="selectborder" {MSIE_DISABLED}>
...
<!-- END host_contactgroups -->
                            ...
                            <td>
                                <table cellpadding="0" cellspacing="0" border="0">
                                    <tr class="{VERSION_30_VISIBLE}">
                                        <td>
                                            <select title="{LANG_CONTACTS}" name="mselValue3[]" size="4" multiple id="mselValue3" class="selectborder" {MSIE_DISABLED}>
<!-- BEGIN host_contacts -->
...
<!-- END notifyperiod -->
                        ...
                        <tr>
                            ...
                            <td><input title="{LANG_NOTIFICATION_INTERVAL}" name="tfNullVal7" type="text" id="tfNullVal7" value="{DAT_NOTIFICATION_INTERVAL}" class="short"><span class="shorttext">min</span></td>
                ...
                <div id="tab4"> 
                    <table border="0" cellpadding="0" class="content_formtable">
                        ...
                        <tr class="{VERSION_30_VISIBLE}">
                            ...
                            <td class="content_tbl_row2"><input title="{LANG_NOTES}" name="tfValue3" type="text" id="tfValue3" value="{DAT_NOTES}" tabindex="1"></td>
                            ...
                            <td class="content_tbl_row2"><input title="{LANG_VRML_IMAGE}" name="tfValue4" type="text" id="tfValue4" value="{DAT_VRML_IMAGE}" tabindex="6"></td>
                        ...
                        <tr class="{VERSION_30_VISIBLE}">
                            ...
                            <td><input title="{LANG_STATUS_IMAGE}" name="tfValue6" type="text" id="tfValue6" value="{DAT_STATUSMAP_IMAGE}" tabindex="7"></td>
                        ...
                        <tr class="{VERSION_30_VISIBLE}">
                            ...
                            <td><input title="{LANG_2D_COORDS}" name="tfValue9" type="text" id="tfValue9" value="{DAT_2D_COORDS}" class="short" tabindex="8"><span class="shorttext">(x,y)</span></td>
                        ...
                        <tr class="{VERSION_30_VISIBLE}">
                            ...
                            <td><input title="{LANG_ICON_IMAGE_ALT_TEXT}" name="tfValue10" type="text" id="tfValue10" value="{DAT_ICON_IMAGE_ALT}" tabindex="5"></td>
                            ...
                            <td><input title="{LANG_3D_COORDS}" name="tfValue11" type="text" id="tfValue11" value="{DAT_3D_COORDS}" class="short" tabindex="9"><span class="shorttext">(x,y,z)</span></td>
...
<!-- END acc_group -->
                        ...
                        <tr class="{VERSION_30_VISIBLE}">
                            ...
                            <td><input title="{LANG_VARIABLE_NAME}" type="text" name="txtVariablename" id="txtVariablename" tabindex="11"></td>
                        ...
                        <tr class="{VERSION_30_VISIBLE}">
                            ...
                            <td><input title="{LANG_VARIABLE_VALUE}" type="text" name="txtVariablevalue" id="txtVariablevalue" tabindex="12"></td>
