 ...
 * @var string $chkTfValue2 from prepend_content.php
 * @var string $chkTfValue4 from prepend_content.php
 * @var string $chkTfValue5 from prepend_content.php
 * @var string $chkTfValue6 from prepend_content.php
 * @var string $chkTfValue7 from prepend_content.php
 * @var string $chkTfValue8 from prepend_content.php
 * @var string $chkTfValue9 from prepend_content.php
 * @var string $chkTfValue10 from prepend_content.php
 * @var string $chkTfValue11 from prepend_content.php
 * @var string $chkTfValue12 from prepend_content.php
 * @var string $chkTfValue13 from prepend_content.php
 * @var string $chkTfValue14 from prepend_content.php
 * @var string $chkTfValue15 from prepend_content.php
 * @var string $chkTfValue16 from prepend_content.php
 * @var string $chkTfValue17 from prepend_content.php
 * @var string $chkTfValue18 from prepend_content.php
 * @var string $chkTfValue19 from prepend_content.php
 * @var string $chkTfValue20 from prepend_content.php
 * @var string $chkTfValue21 from prepend_content.php
 * @var string $chkTfValue22 from prepend_content.php
 * @var string $chkTfValue23 from prepend_content.php
 * @var int $chkSelValue1 from prepend_content.php
 * @var int $chkSelValue2 from prepend_content.php
 * @var int $chkChbValue1 from prepend_content.php
 * @var int $chkSelAccGr from prepend_content.php
 * @var int $chkSelModify from prepend_content.php
 * @var int $chkActive from prepend_content.php
...
if ($chkModus === 'add') {
    ...
    if (isset($arrModifyData) && ((string)$chkSelModify === 'modify')) {
        /* Process data */
    ...
    if ((string)$chkSelModify === 'errormodify') {
