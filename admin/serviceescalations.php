...
if (($chkModus == "add") || ($chkModus == "refresh")) {
  ...
  if (($chkModus == "refresh") && (count($chkSelEscPeriod) != 0)) $intFieldId = 1;
  ...
  if (($chkModus == "refresh") && (count($chkSelContact) != 0)) $intFieldId = 1;
  ...
  if (($chkModus == "refresh") && (count($chkSelContactGroup) != 0)) $intFieldId = 1;
